...
const TestimonialCard = ({ testimonial }: { testimonial: Testimonial }) => (
  <div className="flex items-start gap-3 rounded-3xl bg-card/40 dark:bg-zinc-800/40 backdrop-blur-xl border border-white/10 p-5 w-64">
...
export const SignInPage: React.FC<SignInPageProps> = ({
  ...
  return (
    <div className="h-[100dvh] flex flex-col md:flex-row font-geist w-[100dvw]">
      ...
      <section className="flex-1 flex flex-col overflow-y-auto p-4 md:p-8">
        <div className="w-full max-w-md m-auto py-8">
          <div className="flex flex-col gap-4">
            ...
            {/* The actual form is passed via children to allow separate Login vs Register logic */}
            {children}
          </div>
        </div>
      </section>
