...
const PureChatItem = ({
  ...
  return (
    <SidebarMenuItem>
      <SidebarMenuButton
        asChild
        className="h-8 rounded-lg px-2.5 font-medium text-[13px] text-sidebar-foreground/78 hover:text-sidebar-accent-foreground data-[active=true]:text-sidebar-accent-foreground"
        isActive={isActive}
      >
