...
export const JuristoLogo = ({ size = 16 }: { size?: number }) => (
  <Image
    src="https://storage.googleapis.com/juristo-prod/1a0cbab1-1639-444d-8450-2e30fbf9b9ff/Juristo%20logo%20dark.png"
    alt="Juristo Logo"
    width={size}
    height={size}
...
export const BarChart3Icon = ({ size = 16 }: { size?: number }) => (
  <svg
    height={size}
    width={size}
    viewBox="0 0 24 24"
...
// Additional icons for contracts feature
export const FileTextIcon = ({ size = 16, className }: { size?: number; className?: string }) => (
  ...
  >
    <path
      clipRule="evenodd"
      d="M14.5 13.5V6.5H10V2H5.5V13.5H14.5ZM4 1H10.4142L16 6.58579V13.5C16 14.3284 15.3284 15 14.5 15H4C3.17157 15 2.5 14.3284 2.5 13.5V2.5C2.5 1.67157 3.17157 1 4 1ZM6 8H14V9.5H6V8ZM14 11H6V12.5H14V11Z"
      fill="currentColor"
      fillRule="evenodd"
    />
  </svg>
...
export const StarIcon = ({ size = 16, className }: { size?: number; className?: string }) => (
  <svg
    height={size}
    strokeLinejoin="round"
    style={{ color: "currentcolor" }}
  ...
  >
    <path
      d="M8 1l2.236 4.528 5 .727-3.618 3.529.854 4.98L8 12.264l-4.472 2.5.854-4.98L.764 6.255l5-.727L8 1z"
      fill="currentColor"
    />
  </svg>
);
...
export const CheckIcon = ({ size = 16, className }: { size?: number; className?: string }) => (
  ...
  >
    <path
      clipRule="evenodd"
      d="M13.7803 4.46967L14.3107 5L6.56066 12.75L1.68934 7.87868L2.21967 7.34835L2.75 6.81802L3.81066 7.87868L6.03033 10.0983L12.7197 3.40901L13.25 2.87868L14.3107 3.93934L13.7803 4.46967Z"
      fill="currentColor"
      fillRule="evenodd"
    />
  </svg>
...
export const ArrowLeftIcon = ({ size = 16, className }: { size?: number; className?: string }) => (
  <svg
    height={size}
    strokeLinejoin="round"
    style={{ color: "currentcolor" }}
  ...
  >
    <path
      clipRule="evenodd"
      d="M7.78033 12.5303L8.31066 12L7.25 10.9393L6.71967 11.4697L3.56066 8.31066L3.03033 7.78033L3.56066 7.25L6.71967 4.09099L7.25 3.56066L8.31066 4.62132L7.78033 5.15165L5.93198 7H13.25H14V8.5H13.25H5.93198L7.78033 10.3484L7.78033 12.5303Z"
      fill="currentColor"
      fillRule="evenodd"
    />
  </svg>
...
export const EditIcon = ({ size = 16, className }: { size?: number; className?: string }) => (
  <svg
    height={size}
    strokeLinejoin="round"
    style={{ color: "currentcolor" }}
  ...
  >
    <path
      clipRule="evenodd"
      d="M11.0303 1.53033L12.5 0L14.5607 2.06066L13.0303 3.59099L11.0303 1.53033ZM1 10.5L9.46967 2.03033L11.5303 4.09099L3.06066 12.5607L1 14V10.5Z"
      fill="currentColor"
      fillRule="evenodd"
    />
  </svg>
...
export const SearchIcon = ({ size = 16, className }: { size?: number; className?: string }) => (
  ...
  >
    <path
      clipRule="evenodd"
      d="M3.5 7C3.5 5.067 5.067 3.5 7 3.5C8.933 3.5 10.5 5.067 10.5 7C10.5 8.933 8.933 10.5 7 10.5C5.067 10.5 3.5 8.933 3.5 7ZM7 2C4.23858 2 2 4.23858 2 7C2 9.76142 4.23858 12 7 12C8.01879 12 8.96742 11.7082 9.75777 11.2019L13.2782 14.7224L14.6924 13.3082L11.1719 9.78772C11.6776 8.9977 11.9692 8.04957 12 7.03131L12 7C12 4.23858 9.76142 2 7 2Z"
      fill="currentColor"
      fillRule="evenodd"
    />
  </svg>
...
export const ShieldIcon = ({ size = 16, className }: { size?: number; className?: string }) => (
  ...
  >
    <path
      clipRule="evenodd"
      d="M8 1L2 3V7C2 11.4183 4.46243 14 8 15C11.5376 14 14 11.4183 14 7V3L8 1ZM12.5 7V4L8 2.5L3.5 4V7C3.5 10.5 5.5 12.5 8 13.5C10.5 12.5 12.5 10.5 12.5 7Z"
      fill="currentColor"
      fillRule="evenodd"
    />
  </svg>
...
export const UsersIcon = ({ size = 16, className }: { size?: number; className?: string }) => (
  <svg
    height={size}
    strokeLinejoin="round"
    style={{ color: "currentcolor" }}
  ...
  >
    <path
      clipRule="evenodd"
      d="M5.5 4C5.5 2.89543 6.39543 2 7.5 2C8.60457 2 9.5 2.89543 9.5 4C9.5 5.10457 8.60457 6 7.5 6C6.39543 6 5.5 5.10457 5.5 4ZM11.5 5C11.5 4.17157 12.1716 3.5 13 3.5C13.8284 3.5 14.5 4.17157 14.5 5C14.5 5.82843 13.8284 6.5 13 6.5C12.1716 6.5 11.5 5.82843 11.5 5ZM0.5 5C0.5 4.17157 1.17157 3.5 2 3.5C2.82843 3.5 3.5 4.17157 3.5 5C3.5 5.82843 2.82843 6.5 2 6.5C1.17157 6.5 0.5 5.82843 0.5 5ZM3.5 9C3.5 7.89543 4.39543 7 5.5 7H9.5C10.6046 7 11.5 7.89543 11.5 9V13H3.5V9ZM0 10C0 9.44772 0.447715 9 1 9H2.5V13H0V10ZM12.5 9H14C14.5523 9 15 9.44772 15 10V13H12.5V9Z"
      fill="currentColor"
      fillRule="evenodd"
    />
  </svg>
...
export const BriefcaseIcon = ({ size = 16, className }: { size?: number; className?: string }) => (
  <svg
    height={size}
    strokeLinejoin="round"
    style={{ color: "currentcolor" }}
  ...
  >
    <path
      clipRule="evenodd"
      d="M5 2.5C5 1.67157 5.67157 1 6.5 1H9.5C10.3284 1 11 1.67157 11 2.5V4H14.5C15.3284 4 16 4.67157 16 5.5V13.5C16 14.3284 15.3284 15 14.5 15H1.5C0.671573 15 0 14.3284 0 13.5V5.5C0 4.67157 0.671573 4 1.5 4H5V2.5ZM9.5 2.5H6.5V4H9.5V2.5ZM1.5 5.5V13.5H14.5V5.5H1.5Z"
      fill="currentColor"
      fillRule="evenodd"
    />
  </svg>
...
export const BuildingIcon = ({ size = 16, className }: { size?: number; className?: string }) => (
  <svg
    height={size}
    strokeLinejoin="round"
    style={{ color: "currentcolor" }}
  ...
  >
    <path
      clipRule="evenodd"
      d="M1 15V1.5C1 0.671573 1.67157 0 2.5 0H10.5C11.3284 0 12 0.671573 12 1.5V6H14.5C15.3284 6 16 6.67157 16 7.5V15H1ZM10.5 15V1.5H2.5V15H10.5ZM12 15V7.5H14.5V15H12ZM4 4H6V5.5H4V4ZM6 7H4V8.5H6V7ZM4 10H6V11.5H4V10ZM9 4H7V5.5H9V4ZM7 7H9V8.5H7V7ZM9 10H7V11.5H9V10Z"
      fill="currentColor"
      fillRule="evenodd"
    />
  </svg>
...
export const ScaleIcon = ({ size = 16, className }: { size?: number; className?: string }) => (
  <svg
    height={size}
    strokeLinejoin="round"
    style={{ color: "currentcolor" }}
  ...
  >
    <path
      clipRule="evenodd"
      d="M8 1L8 2L12.5 4L16 10H12.5H9L12.5 4L8 2L3.5 4L7 10H3.5H0L3.5 4L8 2V1H8ZM8 3.5L4.5 5.5L3.17 8.5H6.83L5.5 5.5L8 3.5ZM10.5 5.5L9.17 8.5H12.83L11.5 5.5L8 3.5L10.5 5.5ZM7.25 12V15H8.75V12H7.25ZM3 14H13V15.5H3V14Z"
      fill="currentColor"
      fillRule="evenodd"
    />
  </svg>
...
export const HeartIcon = ({ size = 16, className }: { size?: number; className?: string }) => (
  ...
  >
    <path
      d="M8 3.56911C6.80068 2.24303 4.69798 2.02191 3.11469 3.38979C1.48949 4.79339 1.28946 7.2048 2.59668 8.86004L7.4637 14.4227C7.76405 14.7824 8.23592 14.7824 8.53627 14.4227L13.4033 8.86004C14.7105 7.2048 14.5105 4.79339 12.8853 3.38979C11.302 2.02191 9.19932 2.24303 8 3.56911Z"
      fill="currentColor"
    />
  </svg>
);

export const CarIcon = ({ size = 16, className }: { size?: number; className?: string }) => (
  <svg
    height={size}
    strokeLinejoin="round"
    style={{ color: "currentcolor" }}
  ...
  >
    <path
      clipRule="evenodd"
      d="M3.5 3C2.67157 3 2 3.67157 2 4.5V6H14V4.5C14 3.67157 13.3284 3 12.5 3H3.5ZM1 7.5V11.5C1 12.0523 1.44772 12.5 2 12.5V14H4V12.5H12V14H14V12.5C14.5523 12.5 15 12.0523 15 11.5V7.5H1ZM3.5 10C4.05228 10 4.5 9.55228 4.5 9C4.5 8.44772 4.05228 8 3.5 8C2.94772 8 2.5 8.44772 2.5 9C2.5 9.55228 2.94772 10 3.5 10ZM13.5 9C13.5 9.55228 13.0523 10 12.5 10C11.9477 10 11.5 9.55228 11.5 9C11.5 8.44772 11.9477 8 12.5 8C13.0523 8 13.5 8.44772 13.5 9Z"
      fill="currentColor"
      fillRule="evenodd"
    />
  </svg>
