...
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_user_activity_user_occurred" ON "UserActivityEvent" ("userId", "occurredAt" DESC);
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_user_activity_event_type" ON "UserActivityEvent" ("eventType");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_user_activity_chat" ON "UserActivityEvent" ("chatId");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_user_keyword_user_keyword" ON "UserKeywordInsight" ("userId", "keyword");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_user_keyword_last_used" ON "UserKeywordInsight" ("lastUsedAt" DESC);
